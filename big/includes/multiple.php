...
#EDIT THE FOLLOWING:
$toAddress = "giantspork@gmail.com";  //place your/your client's email address here
$toName = "Nicole Brown"; //place your client's name here
...
include_once 'big-config.php'; #site keys go inside your big-config.php file
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thanks for your interest in our web services. We will get back to you within two business days.</h2> 
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
